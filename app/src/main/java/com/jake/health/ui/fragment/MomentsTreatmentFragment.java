 ...
 */
public class MomentsTreatmentFragment extends BaseListFragment<QAInfo> {
    @Override
    ...
    public static String getTabTitle() {
        return HealthApplication.getInstance().getString(R.string.tab_moments_treatment);
    }

    public static MomentsTreatmentFragment newInstance() {
        return new MomentsTreatmentFragment();
    }
}