 ...
 */
public class MomentsChildFragment extends BaseListFragment<QAInfo> {
    @Override
    ...
    public static String getTabTitle() {
        return HealthApplication.getInstance().getString(R.string.tab_moments_child);
    }

    public static MomentsChildFragment newInstance() {
        return new MomentsChildFragment();
    }
}
