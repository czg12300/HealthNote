...
package com.jake.health.ui.widgt.indicator;
...
public class IndicatorViewPager extends LinearLayout implements OnPageChangeListener {
    ...
    private void initView() {
        ...
        vDivider.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, 0));
        addView(vDivider);
    ...
    public void setDividerHeight(int px) {
        LayoutParams params = (LayoutParams) vDivider.getLayoutParams();
        params.height = px;
