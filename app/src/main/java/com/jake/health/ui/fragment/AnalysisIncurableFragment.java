 ...
 */
public class AnalysisIncurableFragment extends BaseListFragment<QAInfo> {
    @Override
    ...
    public static String getTabTitle(){
        return HealthApplication.getInstance().getString(R.string.tab_analysis_incurable);
    }
    public static AnalysisIncurableFragment newInstance() {
        return new AnalysisIncurableFragment();
    }
}
